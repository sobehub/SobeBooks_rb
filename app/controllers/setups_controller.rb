class SetupsController < ApplicationController
  ...
  # GET /setups.json
  def index
    @setups = current_user.setups.all
    @setup = Setup.new
  end
  ...
  def create
    ...
    respond_to do |format|
      if @setup.save
        format.html { redirect_to setups_path, notice: 'Setup was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @setup.update(setup_params)
        format.html { redirect_to setups_path, notice: 'Setup was successfully updated.' }
  ...
  private
    ...
    def setup_params
      params.require(:setup).permit(:typeofsetup, :description, :user_id,:setuptype)
    end
end
