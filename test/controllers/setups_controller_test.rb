...
class SetupsControllerTest < ActionController::TestCase
  ...
  test "should create setup" do
    assert_difference('Setup.count') do
      post :create, setup: { description: @setup.description, type: @setup.type, user_id: @setup.user_id }
    end
  ...
  test "should update setup" do
    patch :update, id: @setup, setup: { description: @setup.description, type: @setup.type, user_id: @setup.user_id }
    assert_redirected_to setup_path(assigns(:setup))
  end
